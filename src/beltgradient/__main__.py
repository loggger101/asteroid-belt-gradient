...
def main(argv=None) -> None:
    ...
    sub.add_parser("fetch", help="download and verify the catalog snapshot and the Nesvorný families")
    r = sub.add_parser("run", help="regenerate every figure and results/summary.json (~2 min)")
