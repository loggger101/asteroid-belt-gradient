...
* The AsteroidCatalog release ``CATALOG_RELEASE`` (``data-2026-09-26b``: 1,567,859 bodies, data
  contract 1.5.0). A release is one frozen build that is never rebuilt under its tag; the sha256
...
CATALOG_SHA256 = "5b4da5c119d964f39e29567df2d9bb10b0aaaa636480feccc1297335e5a4c7b0"
